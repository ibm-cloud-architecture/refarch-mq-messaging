...
public class JmsPutGet {
	...
	private static final String QMGR = "LQM1"; // Queue manager name
	...
	private static final String QUEUE_NAME = "REQ.BROWN"; // Queue that the application uses to put and get messages to and from
