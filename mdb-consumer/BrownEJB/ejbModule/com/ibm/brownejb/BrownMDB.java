...
/**
 * Message-Driven Bean implementation class for: BrownMDB
 */
@MessageDriven(
		activationConfig = { @ActivationConfigProperty(
				propertyName = "destinationType", propertyValue = "javax.jms.Queue")
		})
public class BrownMDB implements MessageListener {
	
    @Resource
    private MessageDrivenContext mdCtx;
    
    @Resource(name = "jms/BrownConnectionFactory")
    private ConnectionFactory connectionFactoryRef;
    
    @Resource(name = "jms/BrownResponseQueue")
